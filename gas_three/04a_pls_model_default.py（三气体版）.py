...
# 保存
pd.DataFrame(Y_test, columns=["NO_true", "NO2_true", "SO2_true"]).to_csv("Y_test_default.csv", index=False)
pd.DataFrame(Y_pred, columns=["NO_pred", "NO2_pred", "SO2_pred"]).to_csv("Y_pred_default.csv", index=False)
