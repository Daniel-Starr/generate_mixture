# -*- coding: utf-8 -*-
"""
CS2 → Voigt absorbance from HITRAN HDF5
- Reads HITRAN HDF5 (lbl) at: E:\generate_mixture\gas_hdf5\cs2.hdf5
...
# ------------------ USER SETTINGS ------------------
H5_PATH = r"E:\generate_mixture\gas_hdf5\SC2.hdf5"
OUT_DIR = r"../output_hdf5_test"
MOLEC_ID = None     # None (auto-detect; must be unique in file). If None -> auto-detect (must be unique in file)
MOLAR_MASS = 76.14 # g/mol (used for Doppler broadening)
