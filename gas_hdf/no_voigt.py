# -*- coding: utf-8 -*-
"""
NO → Voigt absorbance from HITRAN HDF5
...
# ------------------ USER SETTINGS ------------------
H5_PATH = r"E:\generate_mixture\gas_hdf5\NO.hdf5"
OUT_DIR = r"../output_hdf5_test"
MOLEC_ID = None     # 8=NO. If None -> auto-detect (must be unique in file)
MOLAR_MASS = 30.0061 # g/mol (used for Doppler broadening)
