# -*- coding: utf-8 -*-
"""
SO2 → Voigt absorbance from HITRAN HDF5
- Reads HITRAN HDF5 (lbl) at: E:\generate_mixture\gas_hdf5\so2.hdf5
...
# ------------------ USER SETTINGS ------------------
H5_PATH = r"E:\generate_mixture\gas_hdf5\SO2.hdf5"
OUT_DIR = r"../output_hdf5_test"
MOLEC_ID = 9     # 9=SO2. If None -> auto-detect (must be unique in file)
MOLAR_MASS = 64.066 # g/mol (used for Doppler broadening)
